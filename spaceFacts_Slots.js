...
const handlers = {
    ...
    'GetFact': function () {
        ...
        var planetName = this.event.request.intent.slots.PlanetName.value;
        console.log("Slot is ", planetName);
        ...
        if (planetName) {
            ...
            if (factArr[i].toLowerCase().includes(planetName)) {
                console.log("the match is " + factArr[i]);
